...
{
    public class WWOMarineWeatherInput
    {
    ...
    public class Data
    {
        ...
        public List<WWOWeather> weather;
    }

    public class WWOWeather
    {
        public DateTime date { get; set; }
        public List<WWOAstronomy> astronomy { get; set; }
        public List<WWOHourly> hourly { get; set; }
