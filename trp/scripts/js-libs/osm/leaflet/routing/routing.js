...
L.Routing = L.Control.extend({
  ...
  , options: {
    ...
    , icons: {
      ...
      //, draw: new L.Icon({
      //    iconUrl: '../../contents/images/osm/circle-green.png',
      //    iconSize:[10,10]
      //})
    }
    , styles: {
  ...
  , onAdd: function (map) {
      ...
      this.on('waypoint:dblclick', this._waypointClickHandler, this)
  ...
  , onRemove: function (map) {
      ...
      this.off('waypoint:dblclick', this._waypointClickHandler, this)
  ...
  , addWaypoint: function (marker, prev, next, cb) {
      ...
      marker.on('dblclick', this._fireWaypointEvent, this);
