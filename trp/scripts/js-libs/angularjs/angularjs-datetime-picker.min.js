(function () {
    ...
    var DatetimePickerCtrl = function ($compile, $document) {
        ...
        this.openDatetimePicker = function (options) {
            ...
            //console.log(bcr.right)
            //console.log(bcr.left)
            //console.log(datePickerElBcr.width)
            //console.log(window.scrollX)
            datetimePickerEl.style.position = 'absolute';
            if (bcr.width > datePickerElBcr.width) {
                datetimePickerEl.style.left = (bcr.right - datePickerElBcr.width) + 'px';
            } else {
                if (localStorage.getItem('history') == 'from') {
    ...
    var datetimePickerPopup = function ($locale, dateFilter) {
        ...
        var linkFunc = function (scope, element, attrs, ctrl) { //jshint ignore:line
            ...
            scope.$watch(function () {
                return scope.mv.month;
            }, function (data) {
                scope.mv.month = data;
            }, true);

            scope.$watch(function () {
                return scope.mv.year;
            }, function (data) {
                scope.mv.year = data;
            }, true);
