...
namespace Philgps_WebAPI.Controllers.Geofence
{
    ...
    public class GeofenceController : ApiController
    {
        ...
        [HttpPost]
        public IHttpActionResult GetUserZoneList(ZoneLoadParameter _Param)
        {
            var Identity = (ClaimsIdentity)User.Identity;
            IEnumerable<Claim> Claims = Identity.Claims;
            ...
            var UserZoneList = GEOFENCEDBHelpers.GetUserZoneList(AccountID, ParentID, _Param.Take, _Param.NextPage, _Param.Keyword, WebConfigurationName);
        ...
        public IHttpActionResult GetUserZoneList()
        {
            ...
            var UserZoneList = GEOFENCEDBHelpers.GetZoneList(AccountID, ParentID, WebConfigurationName);
            if (UserZoneList != null)
            {
                return Ok(UserZoneList);
            }
        ...
        [Authorize]
        [Route("Zone/Filter/Assets/{_Allowed}")]
        [HttpPost]
        public IHttpActionResult GeZoneFilterAssets(bool _Allowed)
        {
            var Identity = (ClaimsIdentity)User.Identity;
            IEnumerable<Claim> Claims = Identity.Claims;
            int AccountID = Claims.Where(x => x.Type == "AccountID").FirstOrDefault().Value.ToString().strToInt();
            ...
            return Ok(GEOFENCEDBHelpers.getZoneFilterAssets(AccountID, _Allowed, WebConfigurationName));
        }

        [Authorize]
        [HttpPost]
        [Route("Zone/Filter/Assets/All")]
        public IHttpActionResult getZoneFilterAssetsAll()
        {
            var Identity = (ClaimsIdentity)User.Identity;
            IEnumerable<Claim> Claims = Identity.Claims;
            int AccountID = Claims.Where(x => x.Type == "AccountID").FirstOrDefault().Value.ToString().strToInt();
            ...
            return Ok(GEOFENCEDBHelpers.getZonefilterAssetsAll(AccountID, WebConfigurationName));
        }

        [Authorize]
        [Route("Zone/User/Count")]
        [HttpPost]
        public IHttpActionResult GetCountUserZoneList()
        {
            var Identity = (ClaimsIdentity)User.Identity;
            IEnumerable<Claim> Claims = Identity.Claims;
            int AccountID = Claims.Where(x => x.Type == "AccountID").FirstOrDefault().Value.ToString().strToInt();
            ...
            var result = GEOFENCEDBHelpers.GetCountZoneList(AccountID, ParentID, WebConfigurationName);
        ...
        [Authorize]
        [Route("Zone/Asset/Count/{_AssetID}")]
        [HttpPost]
        public IHttpActionResult GetCountAssetZoneList(string _AssetID)
        {
            var Identity = (ClaimsIdentity)User.Identity;
            IEnumerable<Claim> Claims = Identity.Claims;
            int AccountID = Claims.Where(x => x.Type == "AccountID").FirstOrDefault().Value.ToString().strToInt();
            ...
            var result = GEOFENCEDBHelpers.GetCountAssetZoneList(_AssetID, AccountID, WebConfigurationName);
        ...
        [HttpPost]
        public IHttpActionResult GetAssetZoneList(string _AssetID, ZoneLoadParameter _Param)
        {
            var Identity = (ClaimsIdentity)User.Identity;
            IEnumerable<Claim> Claims = Identity.Claims;
            int AccountID = Claims.Where(x => x.Type == "AccountID").FirstOrDefault().Value.ToString().strToInt();
            ...
            var AssetZoneList = GEOFENCEDBHelpers.GetAssetZoneList(AccountID, _AssetID, _Param.Take, _Param.NextPage, WebConfigurationName);
        ...
        public IHttpActionResult GetAssetZoneList(int _ZoneID)
        {
            ...
            var CustomerList = TFDBHelpers.GetAssetListSystemUser(AccountID, TFDBWebConfigurationName).ToList();
        ...
        [Authorize]
        [Route("Asset/Inside/Zone")]
        [HttpPost]
        public IHttpActionResult getInsideZoneAssetList(insideZone _params)
        {
            var Identity = (ClaimsIdentity)User.Identity;
            IEnumerable<Claim> Claims = Identity.Claims;
            int AccountID = Claims.Where(x => x.Type == "AccountID").FirstOrDefault().Value.ToString().strToInt();
            ...
            var zone = GEOFENCEDBHelpers.getInsideZoneList(_params, WebConfigurationName);
            return Ok(zone);
        ...
        //[Authorize]
        //[Route("Asset/Outside/Zone")]
        //[HttpPost]
        //public IHttpActionResult getOutsideZoneAssetList()
        //{
        //    var Identity = (ClaimsIdentity)User.Identity;
        //    IEnumerable<Claim> Claims = Identity.Claims;
        //    int AccountID = Claims.Where(x => x.Type == "AccountID").FirstOrDefault().Value.ToString().strToInt();
        ...
        //    var zone = GEOFENCEDBHelpers.getOutsideZoneList(AccountID, WebConfigurationName);
        //    return Ok(zone);
        ...
        [Route("Zone/Search")]
        [HttpPost]
        public IHttpActionResult SearchAllZoneList(ZoneLoadParameter _Param)
        {
            var Identity = (ClaimsIdentity)User.Identity;
            IEnumerable<Claim> Claims = Identity.Claims;
            int AccountID = Claims.Where(x => x.Type == "AccountID").FirstOrDefault().Value.ToString().strToInt();
            ...
            var result = GEOFENCEDBHelpers.SearchAllZoneList(AccountID, ParentID, _Param.NextPage, _Param.Take, _Param.Keyword, WebConfigurationName);

            return Ok(result);
        }

        [Authorize]
        [Route("Zone/Search/{_AssetID}")]
        [HttpPost]
        public IHttpActionResult SearchAssetZone(string _AssetID, ZoneLoadParameter _Param)
        {
            var Identity = (ClaimsIdentity)User.Identity;
            IEnumerable<Claim> Claims = Identity.Claims;
            int AccountID = Claims.Where(x => x.Type == "AccountID").FirstOrDefault().Value.ToString().strToInt();
            ...
            var result = GEOFENCEDBHelpers.SearchAssetZoneList(AccountID, _AssetID, _Param.Take, _Param.Keyword, WebConfigurationName);
        ...
        [Authorize]
        [Route("User/Assets/Route/Status/List")]
        [HttpGet]
        public IHttpActionResult GetUserRouteStatusList()
        {
            var Identity = (ClaimsIdentity)User.Identity;
            IEnumerable<Claim> Claims = Identity.Claims;
            int AccountID = Claims.Where(x => x.Type == "AccountID").FirstOrDefault().Value.ToString().strToInt();
            ...
            var result = GEOFENCEDBHelpers.GetUserRouteStatusList(AccountID, WebConfigurationName);
        ...
        public IHttpActionResult GetAssetAssignedRouteList(int _RouteID)
        {
            ...
            var CustomerList = TFDBHelpers.GetAssetList(AccountID, TFDBWebConfigurationName).ToList();
            if (CustomerList != null)
            {
                List<AssignmentCustomer> auca = new List<AssignmentCustomer>();
                foreach (var c in CustomerList)
